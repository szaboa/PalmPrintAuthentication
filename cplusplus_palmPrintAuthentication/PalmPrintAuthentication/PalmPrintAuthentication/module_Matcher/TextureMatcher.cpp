...
int TextureMatcher::doMatching(IFeature* f){
	...
	for (auto it = records.begin(); it < records.end(); ++it){
		...
		if (reMat.size() != searchReMat.size() || imMat.size() != searchImMat.size()) Logger::log("TextureMatcher", "Different size"); // throw exception
	...
	cout << "Matched: " << minUserId << endl;
	Logger::log("MATCH","Distance: " + to_string(minScore) +  " Matched: " +  to_string(minUserId));
