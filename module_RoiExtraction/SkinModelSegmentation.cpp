...
SkinModelSegmentation::SkinModelSegmentation()
{
}



Mat SkinModelSegmentation::doPreprocessing(const cv::Mat &inputImage){
...
Mat SkinModelSegmentation::doRegionSegmentation(const cv::Mat &preprocessedImage){
